...
// singleton boilerplate
  ...
  Future<bool> predict(List data) {
    /// search closer user prediction if exists
    return _searchResult(_predictedData!, data);
  }
  ...
  Future<List> preProcess(CameraImage image, Face faceDetected) async {
    // crops the face 💇
    imglib.Image croppedImage = _cropFace(image, faceDetected);
    imglib.Image img = imglib.copyResizeCropSquare(croppedImage, 112);
  ...
  Future<bool> _searchResult(List predictedData, List data) async {
